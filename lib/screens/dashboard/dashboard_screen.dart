...
import '../invoices/create_invoice_dialog.dart';
import '../patients/patient_form_dialog.dart';
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: () => BookAppointmentDialog.show(
                          context,
                      ...
                      OutlinedButton.icon(
                        onPressed: () => PatientFormDialog.show(context),
